...
func validarEntradas3(rangoMin float64,rangoMax float64,datos int,diaInicio int,diaFinal int) (string, bool){
	var mensaje string
	var err bool
...
func main() {
	...
	if err != false{
		...
		slice2 := strings.Join(slice, " ") //El slice lo pasamos a tipo string, " "- significa que va hacer un espacio en blanco
